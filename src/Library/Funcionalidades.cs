...
namespace Library
{
    public class Funciones
    {
        public static void Ataque(Personaje a, Personaje b, string description)
        {
            ...
            Console.WriteLine("{0] ataca al personaje {1} ahora su vida es de {3}", a, b, a.Vida);
        }
        ...
        public static void Cura(Personaje a, Personaje b, string description)
        {
            ...
            Console.WriteLine("{0} esta curando al personaje {1} ahora su vida es de {3}", a, b, a.Vida);
        }
